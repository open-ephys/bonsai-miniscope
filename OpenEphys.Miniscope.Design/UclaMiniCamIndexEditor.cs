...
{
    /// <summary>
    /// A value editor that allows users to scan for UVC indices that represent UCLA Minicam devices.
    /// </summary>
    public class UclaMiniCamIndexEditor : UITypeEditor
    {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (context != null && editorService != null)
            {
                ...
                using var editorDialog = new UclaMiniscopeSelectionDialog(ScopeKind.MiniCam);
