...
{
    /// <summary>
    /// Represents an operator that transforms a sequence of quaternions into an axis-angle representation using the Tait-Bryan formalism.
    /// </summary>
    /// <remarks>
    ...
    /// Roll gives the bank angle, which is the rotation about X'' after application of Yaw and Pitch to the ENU coordinates.
    /// </remarks>
    ...
    {
        /// <summary>
        /// Transforms an observable sequence of quaternions into Tait-Bryan angles.
        /// </summary>
        /// <param name="source">
        /// An observable sequence of <see cref="Quaternion"/> values representing the spatial rotations to transform.
        /// </param>
        /// <returns>
        /// A sequence of <see cref="TaitBryanAngles"/> where each value represents the corresponding rotation decomposed into yaw, pitch, and roll.
        /// </returns>
